...
public class MainActivity extends AppCompatActivity {
    ...
    public void promedio(View v ){
        ...
        String result1 = String.valueOf(Math.round((mate1_1+mate1_2+mate1_3+mate1_4)/4));
        ...
        String result2 = String.valueOf((Math.round(mate2_1+mate2_2+mate2_3+mate2_4)/4));
        ...
        String result3 = String.valueOf(Math.round((mate3_1+mate3_2+mate3_3+mate3_4)/4));
        ...
        String final1_1 = String.valueOf(Math.round((promedio1 + promedio2 + promedio3)/3));
    ...
    public void siguiente(View view){
        ...
        siguiente.putExtra("Promedio", promedio);
